...
INSERT INTO `divmatches` VALUES (9,10),(9,12),(10,9),(10,12),(12,9),(12,10);
...
INSERT INTO `player_leaguematch` VALUES (1,1,1,3,1,NULL,0,1,4),(1,1,1,3,2,NULL,2,NULL,5),(1,1,1,3,3,NULL,3,NULL,6),(1,1,1,3,4,NULL,3,NULL,7),(1,1,1,4,1,NULL,3,NULL,3),(1,1,1,4,5,NULL,1,NULL,5),(1,1,1,4,6,NULL,3,NULL,6),(1,1,1,4,7,NULL,3,NULL,7),(1,1,1,5,2,NULL,2,NULL,3),(1,1,1,5,5,NULL,3,NULL,4),(1,1,1,5,8,NULL,3,NULL,7),(1,1,1,6,3,NULL,2,NULL,3),(1,1,1,6,6,NULL,0,NULL,4),(1,1,1,6,9,NULL,1,NULL,7),(1,1,1,7,4,NULL,1,NULL,3),(1,1,1,7,7,NULL,1,NULL,4),(1,1,1,7,8,NULL,2,NULL,5),(1,1,1,7,9,NULL,3,NULL,6),(1,1,2,9,10,NULL,3,NULL,10),(1,1,2,9,11,NULL,3,NULL,12),(1,1,2,10,10,NULL,2,NULL,9),(1,1,2,10,12,NULL,3,NULL,12),(1,1,2,12,11,NULL,0,NULL,9),(1,1,2,12,12,NULL,1,NULL,10),(1,1,3,8,13,NULL,3,NULL,11),(1,1,3,11,13,NULL,0,NULL,8),(1,1,3,11,14,NULL,3,NULL,13),(1,1,3,13,14,NULL,0,NULL,11),(2,1,1,15,15,3,3,NULL,16),(2,1,1,16,15,1,0,NULL,15);
...
BEGIN
    ...
    */
	...
	drop temporary table if exists divMatches;
    create temporary table divMatches (player1_id int, player2_id int);    
    set player1index = 1;
    set player2index = 2;
    ...
    select *,
			sum(p1_score - p2_score) over (partition by player1_id) as gameDiff
	from (
		select 
			player1_id,
			p1.PSN_id as p1_PSN,
...
-- Dump completed on 2020-09-21 23:55:54
