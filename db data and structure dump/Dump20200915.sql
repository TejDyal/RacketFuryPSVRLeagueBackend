...
INSERT INTO `matchresults` VALUES (1,3,0,1,0,2,1),(1,4,3,NULL,3,1,2),(2,3,2,NULL,2,1,1),(2,5,2,NULL,2,1,1),(3,6,2,NULL,1,2,1),(3,3,3,NULL,3,1,2),(4,7,1,NULL,1,2,1),(4,3,3,NULL,3,1,2),(5,4,1,NULL,1,2,1),(5,5,3,NULL,3,1,2),(6,6,0,NULL,1,2,1),(6,4,3,NULL,3,1,2),(7,7,1,NULL,1,2,1),(7,4,3,NULL,3,1,2),(8,7,2,NULL,1,2,1),(8,5,3,NULL,3,1,2),(9,6,1,NULL,1,2,1),(9,7,3,NULL,3,1,2),(10,10,2,NULL,1,2,1),(10,9,3,NULL,3,1,2),(11,12,0,NULL,1,2,1),(11,9,3,NULL,3,1,2),(12,12,1,NULL,1,2,1),(12,10,3,NULL,3,1,2),(13,11,0,NULL,1,2,1),(13,8,3,NULL,3,1,2),(14,13,0,NULL,1,2,1),(14,11,3,NULL,3,1,2);
...
INSERT INTO `player_leaguematch` VALUES (1,1,1,3,1,0,0,1),(1,1,1,3,2,2,2,NULL),(1,1,1,3,3,3,3,NULL),(1,1,1,3,4,3,3,NULL),(1,1,1,4,1,3,3,NULL),(1,1,1,4,5,1,1,NULL),(1,1,1,4,6,3,3,NULL),(1,1,1,4,7,3,3,NULL),(1,1,1,5,2,2,2,NULL),(1,1,1,5,5,3,3,NULL),(1,1,1,5,8,3,3,NULL),(1,1,1,6,3,1,2,NULL),(1,1,1,6,6,1,0,NULL),(1,1,1,6,9,1,1,NULL),(1,1,1,7,4,1,1,NULL),(1,1,1,7,7,1,1,NULL),(1,1,1,7,8,1,2,NULL),(1,1,1,7,9,3,3,NULL),(1,1,2,9,10,3,3,NULL),(1,1,2,9,11,3,3,NULL),(1,1,2,10,10,1,2,NULL),(1,1,2,10,12,3,3,NULL),(1,1,2,12,11,1,0,NULL),(1,1,2,12,12,1,1,NULL),(1,1,3,8,13,3,3,NULL),(1,1,3,11,13,1,0,NULL),(1,1,3,11,14,3,3,NULL),(1,1,3,13,14,1,0,NULL),(2,1,1,15,15,NULL,3,NULL),(2,1,1,16,15,NULL,0,NULL);
...
INSERT INTO `playersort` VALUES (1,4,10,10,4,1,1,5,1,5),(1,3,8,8,4,1,2,4,2,4),(1,5,8,8,3,1,3,3,3,3),(1,7,6,7,4,1,4,2,4,2),(1,6,3,3,3,1,5,1,5,1),(2,9,6,6,2,1,1,3,1,3),(2,10,4,5,2,1,2,2,2,2),(2,12,2,1,2,1,3,1,3,1),(3,11,4,3,2,0,1,3,1,3),(3,8,3,3,1,1,2,2,2,2),(3,13,1,0,1,1,3,1,3,1);
...
INSERT INTO `tallyplayerpointsbydiv` VALUES (1,4,10,10,4,1),(1,3,8,8,4,1),(1,5,8,8,3,1),(1,7,6,7,4,1),(1,6,3,3,3,1),(2,9,6,6,2,1),(2,10,4,5,2,1),(2,12,2,1,2,1),(3,11,4,3,2,0),(3,8,3,3,1,1),(3,13,1,0,1,1);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `matchResultPoints`(seasonId int, serverId int)
BEGIN
...
BEGIN
    ...
    if seasonId != 1 then
		...
		call seasonResults(seasonId-1, serverId);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `playerStats`(filterBySeason bool, filterByDateRange bool, allSeasons bool, Season int, startDate date, endDate date)
BEGIN
    ...
    */
    ...
    -- work in progress.   Complete implementing season results procedure first
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `seasonResults`(seasonId int, serverId int)
BEGIN
	/*
...
-- Dump completed on 2020-09-15  3:30:02
