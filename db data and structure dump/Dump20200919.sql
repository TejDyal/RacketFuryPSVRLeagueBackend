...
--
-- Table structure for table `divmatches`
--

DROP TABLE IF EXISTS `divmatches`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `divmatches` (
...
--
-- Dumping data for table `divmatches`
--

LOCK TABLES `divmatches` WRITE;
/*!40000 ALTER TABLE `divmatches` DISABLE KEYS */;
INSERT INTO `divmatches` VALUES (3,4),(3,5),(3,6),(3,7),(4,3),(4,5),(4,6),(4,7),(5,3),(5,4),(5,6),(5,7),(6,3),(6,4),(6,5),(6,7),(7,3),(7,4),(7,5),(7,6);
/*!40000 ALTER TABLE `divmatches` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `league_season` VALUES (1,1,'2020-08-11','2020-09-17'),(1,2,'2020-09-22','2020-10-22'),(2,1,'2020-08-11','2020-09-17'),(2,2,'2020-09-22','2020-10-22');
...
INSERT INTO `playermatchhistory` VALUES (1,'2020-08-11',1,1,4,'david',0,3,'Lost'),(2,'2020-08-12',1,1,5,'ellie',2,2,'Draw'),(3,'2020-08-12',1,1,6,'fred',3,2,'Won'),(4,'2020-08-12',1,1,7,'george',3,1,'Won');
...
INSERT INTO `playersindiv` VALUES (3,1),(4,2),(5,3),(6,4),(7,5);
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `divisionProgress` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
BEGIN
    ...
    */
    ...
    /* create a table result set of the the player's career summary */
    drop table if exists playerStats;
    create table playerStats (
		Player_id int,
		psnId varchar(45),
    ...
    values (
        ...
        getHighestDivReached(playerId),
        getNumMatchesPlayed(playerId),
        getMatchesWon(),
        getMatchesLost(),
        getMatchesDrawn()
        );
...
-- Dump completed on 2020-09-19  2:40:21
